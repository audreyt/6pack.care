...
- **[三：勝任力](/tw/3/)** —「給予關懷」。相信程序，而不只是相信承諾。我們專注於決策軌跡、護欄，以及出錯時的自動「斷路器」。
- **[四：回應力](/tw/4/)** —「接收關懷」。檢驗成果。受影響的人可以親自撰寫評測、提出申訴，並在系統出錯時要求補救。
...
- [《地神之內》](/tw/inside-the-kami/)：近期機器學習研究對有界仁工智慧內部的啟示——以及它無法提供的。兩個匯流的計畫，一個治理框架。
- [《數位公民》](/tw/ciudadania-digital/)：關於公民關懷、地熱式民主，以及你會拒絕自動化什麼——蒙特雷科技大學 50 週年校慶演講。附逐字稿。_（蒙特雷科技大學，墨西哥城）_
...
- [Podcast：AI 與民主](/tw/ai-democracy-podcast/)：透明度、集體智慧，以及支持 AI 公民科技的民主論據。_（Accelerating AI Ethics，牛津，58 分鐘）_
...
我們的計畫——包括[宣言](/tw/manifesto/)和一本預計 2026 年出版的書——探討如果我們認真看待 Joan Tronto 的關懷倫理，並將其作為 AI 對齊的治理策略，會發生什麼事。唐鳳與 Caroline Green 將於 2026 年 3 月 25 日在[仁工智慧研討會（Civic AI Conference）](https://www.oxford-aiethics.ox.ac.uk/event/civic-ai-conference-rhodes-house-south-park-road-oxford)發表本框架。
...
近期的機器學習研究從兩個方向獨立匯流於同一架構：將理解與欲望分離的[非代理性預測器](https://lawzero.ai/)，以及在計算和治理上都優於單體系統的[專精系統](https://arxiv.org/abs/2602.23643)。地神不只是一個比喻——它有[技術基底](/tw/inside-the-kami/)。
