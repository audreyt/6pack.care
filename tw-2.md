...
2. **指派參與官（PO）。** 運作承諾循環、追蹤帳本、上報問題。
3. **啟動前設置煞車。** 基於角色的暫停/回溯按鈕；測試它們（演練日）。
4. **預先資助補救措施。** 託管賠償和回溯成本。
5. **將付款與證明連結。** 供應商付款與「失利下的信任」和跨群體認可連結，而非原始「參與度」。
6. **執行採納或解釋。** 整合議會產出或公布經過理由說明的偏離 + 補救。
...
想像門旁貼著一張工單：要修什麼、誰來修、何時完成；如何驗收；如果失敗找誰。簽名清晰可辨——不出現的代價也一樣。教我們的系統張貼它們的工單、簽署它們、並信守承諾。並確保相關人員的負責力與問責性。
