...
勝任的行動會創造新資訊。拒絕聽取它，是通往失敗最快的路。Tronto 將回應力定義為「觀察回應並作出判斷——關懷是否足夠、成功、完整。」至關重要的是：「接受關懷的人不一定是回應的人」——關懷場域中的其他人也可以評估。而且「新的需求必然會出現」，使循環重新回到覺察力。

插圖的框架：_我們檢核成果_——不是那些無法衡量我們所重視之事的指標，而是由受影響者設計、為受影響者服務的指標。

對公民 AI 而言，公開問題其實很簡單：當系統傷害了人，誰能提出異議、要多久才會得到回應、而且因為他說了話，究竟有什麼被改變？
...
- **社群共同編寫的評測。** 受影響社群共同撰寫何謂損害、何謂修復成功的測試。有些團隊之後會把這些訊號接到路由或模型更新上——有時稱為社群回饋強化學習（RLCF）——但那只是次一步的實作選擇。公開承諾應先成立：尺規由社群來寫。
- **共享評測登錄庫。** 把評測做成類似維基百科的公共登錄庫：任何人都可以起草評測，公民社會夥伴負責審閱，實驗室則採納或公開說明理由。這些不是供應商可以偷偷為了過關而訓練的實驗室基準，而是持續演化、由社群維護的測試套件。
