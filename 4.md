...
1. **Expose the appeal button.** Everywhere a decision is shown, a one-click appeal exists with a clock. The decision trace is issued to the user, who chooses whether to unseal it for a public challenge.
