...
- **Community-designed reward.** Train agents with Reinforcement Learning from Community Feedback (RLCF): optimise for cross-group endorsement and trust-under-loss, not raw engagement. The community defines what "good" means — and the definition evolves, but within democratic guardrails: justice, equality, and freedom.
...
- **To Symbiosis (Pack 6):** responsive agent earn the right to stay local.
