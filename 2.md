...
4. **Pre-fund remedies.** Pre-fund escrow for compensation and rollback costs (S0/S1) and community deployments such as mutual insurance pools or automatic pause (S2/S3) — tier by impact, not organisational form.
5. **Tie payment to proof.** Keep vendor pay linked to trust-under-loss and cross-group endorsement, not raw engagement.
...
- **Contract.** Contract promises S1 (livelihood) cases decided in 48h; pause if denials spike >25% in any district; rollback if appeals on a rule exceed 20%.
