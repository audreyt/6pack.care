...
- **Wire brakes before launch.** Role-based pause/rollback buttons; test them.
- **Pre-fund remedies.** S0/S1: escrow for compensation and rollback costs. S2/S3 community deployments: mutual insurance pools or automatic pause — tier by impact, not organisational form.
...
- **Attest & publish.** Independent audits compare behaviour to contract; hash the diffs to a public mirror.
