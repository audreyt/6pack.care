...
「六力」不要求 AI 去*感受*關懷。它提取關懷的關係架構——覺察力、負責力、勝任力、回應力、團結力、共生力——並將每一項轉化為機器可檢驗的設計基元、參與契約和可衡量的結果。其人際關係的起源是其嚴謹性的來源，而非需要致歉的局限。
...
將超級智慧指向「治癒癌症」這類單一目標的危險在於，它將複雜、關係性且生態性的現實，視為某種限制滿足問題（constraint-satisfaction problem）來處理。**[古德哈特定律（Goodhart's Law）](https://en.wikipedia.org/wiki/Goodhart%27s_law)是一條道德法則**。當系統以超人速度最大化單一變量時，它將最佳化代理指標，同時摧毀人類情境。
