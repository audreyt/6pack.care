...
「仁工智慧（Civic AI）」要真正存續，不能寄望壟斷巨頭變得更慷慨。道德訴求不夠，必須建立制度，使合作比單純掠取更具吸引力。以下是五種可實際改造激勵機制的方式，其中幾項已經開始被驗證並正在測試中。
...
對於有理由將技術視為監控和控制工具的邊緣化社群，空降科技「解決方案」只會加深傷口。仁工智慧必須透過剛性基礎設施證明其價值：**責任力**（[Pack 2](../2/)）和**回應力**（[Pack 4](../4/)）。它必須從最小的可行橋樑開始——也許是就當地水質的基本事實達成一致，或儘管政治分歧仍協調災難應對。這些不是公民信念的宏大行動；它們是恰好能建立一層薄薄的程序信任的務實交易。
