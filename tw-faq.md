...
將超級智慧指向「治癒癌症」這類單一目標的危險在於，它將複雜、關係性且生態性的現實，視為某種限制滿足問題（constraint-satisfaction problem）來處理。**[古德哈特定律（Goodhart's Law）](https://en.wikipedia.org/wiki/Goodhart%27s_law)是一條道德法則**：操弄指標會造成真實傷害，而建造鼓勵操弄之系統的設計者，必須為損害承擔責任。當系統以超人速度最大化單一變量時，它將最佳化代理指標，同時摧毀人類情境——而選擇了那個指標的設計者，無法推卸損害的責任。
