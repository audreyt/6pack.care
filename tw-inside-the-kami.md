...
_關懷六力描述的是仁工智慧周圍的一切——治理、問責與社群控制。但裡面應該放什麼？兩個研究計畫指向同一個方向。它們無法解決民主問題，卻能告訴我們，哪一類系統更容易被治理。_

## 支持有界性的技術論證

關懷六力刻意保持技術中立。它的治理應比任何單一模型家族活得更久。但技術中立並不等於技術冷漠。會欺騙的模型，會把監督變成持久消耗戰。通用型優化器，會持續擠壓每一道邊界。黑箱系統，會讓第三力根本無從驗證。

兩個近期的機器學習計畫——Yoshua Bengio 的[科學家 AI](https://lawzero.ai/)與 Yann LeCun 的[超人類可適應智慧](https://arxiv.org/abs/2602.23643)（SAI）——匯聚出一個有用的設計結論：公民 AI 最好的技術基底，不是萬能代理者，而是有界、專精，且把行動權限留在人類授權層的系統。

這種匯流並未解決政治。但它縮小了技術搜尋空間。
...
第二個關鍵主張是架構性的。代理性不是預設值。它是經由模型外層的腳手架進入——人類提出的問題、接上的工具，以及被授權的行動。也正因此，治理必須落在那一層。

## SAI：以專精取得能力

LeCun 的 SAI 計畫攻擊的是另一個迷思：正確目標應該是一個樣樣都行的通用智慧。
...
對公民 AI 而言，含意很直接。地神不應該是一個在各領域遊走的小型主權心智。它應該是一個專家：擅長某一類社群工作，能在工作改變時被替換，且不能把在地成功轉化成普遍授權。

SAI 同樣沒有解決治理問題。專精系統仍然可以被部署去服務壞目的。但它至少移除了一個糟糕的預設：更安全或更聰明的 AI，並不意味著必須由同一個系統包辦一切。

## 共同的設計教訓

Bengio 與 LeCun 解的是不同問題。一方在問如何讓預測可信，另一方在問如何讓能力有效率。即便如此，他們仍然指向同一種公民 AI 形狀。

| 研究結論                 | 對公民 AI 的含意                                       |
| ------------------------ | ------------------------------------------------------ |
| 將真實追蹤與語言模仿分開 | 決策軌跡可以區分經驗證的主張與被報告的主張             |
| 專精優於通用             | 每個地神都應有狹窄的授權範圍                           |
| 模組化系統優於單體       | 公民 AI 應可組合、可替換、可聯邦化                     |
...
**第二力：負責力。** Bengio 留下一個關鍵缺口：誰來決定哪些問題可以被問、在哪些領域裡問、為了什麼目的而問？參與契約（[第二力](/tw/2/)）填補的就是這個缺口。它治理的是模型外層的腳手架：被授權的查詢、來源規則、暫停條件、託管金與採納或解釋義務。
...
這就是我所說的**科學家地神**：不是普世統治者，而是一種內部可信、外部可問責的公民工具。
