...
_關懷六力描述的是仁工智慧周圍的一切——治理、問責、由社群駕馭。但裡面應該放什麼？兩個研究計畫指向同一個方向。它們無法解決民主問題，卻能告訴我們，哪一類系統更容易被治理。_

## 支持有界性的技術論證

關懷六力刻意保持技術中立。它的治理應比任何單一模型家族活得更久。但技術中立並不等於技術冷漠。會欺騙的模型，會把監督變成持久消耗戰。通用型最佳化機器，會持續擠壓每一道邊界。黑箱系統，會讓第三力根本無從驗證。

兩個近期的機器學習計畫——Yoshua Bengio 的[科學家 AI](https://lawzero.ai/)與 Yann LeCun 的[超人類可適應智慧](https://arxiv.org/abs/2602.23643)（SAI）——匯聚出一個有用的設計結論：「仁工智慧」最好的技術基底，不是萬能代理者，而是有界、專精，且把行動權限留在人類授權層的系統。
