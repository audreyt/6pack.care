...
**Liron Shapira**：好的，公道。讓我們進入我認為是核心分歧點的部分。如果我猜對了，我認為這是我們分歧所在：我們對超人類智能出現方式的預期。
...
**Liron Shapira**：公道。讓我這樣來問時間線問題。您同意您我對於奇點究竟何時到來，都處於非常模糊的認知狀態。我對此表示同意。我同意我有一個概率分佈，沒有任何一個特定年份佔到超過二十 % 的概率，所以從這個意義上說，它是一個模糊的概率分佈。
