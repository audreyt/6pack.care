...
- **Boundedness.** Flood-bot's licence caps scope to post-flood relief for six weeks; data TTL is 90 days unless individuals opt-in to transfer.
...
- **Feeds Attentiveness (Pack 1):** retired agents gift maps, evals, and receipts to the commons — better first looks next time.
- **Anchors Responsibility (Pack 2):** bounds and sunsets are contractual.
- **Relies on Competence/Responsiveness (Packs 3, 4):** only competent, responsive agents earn stewardship.
