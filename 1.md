...
- **Rights baseline.** We use the Universal Declaration of Human Rights plus local constitutional rights — not because rights are prior to relationships, but because rights are the threshold condition for relational standing. If someone's basic existence is being erased, they cannot participate in a bridging process. Claims that try to erase someone's standing are recorded but do not set the agenda.
