...
- **Rights baseline.** We use the UN's Universal Declaration of Human Rights plus local constitutional rights — not because rights are prior to relationships, but because rights are the threshold condition for relational standing. If someone's basic existence is being erased, they cannot participate in a bridging process. Claims that try to erase someone's standing are recorded but do not set the agenda.
- **Enoughness.** A good system knows its scope and can let go — a kami that tends a place and leaves when the work is done.
...
Picture a host who welcomes each guest by name, makes space for their baggage, and shows how their presence changes the seating plan. That's attentiveness. And because some guests try to erase others, the host keeps a firm rule: hospitality within a rights-respecting home. Teach our systems to be good hosts over great optimisers, and we will keep more of what's precious and create more that's shareable.
