...
- **探索（開放）：** 我們發送了 20 萬則簡訊（一場「民主抽籤」）。每個人，即使未被選中，都可以使用 Polis 來設定議程。這種廣泛的參與，對正當性的貢獻極大。
- **定義（受保護）：** 我們邀請了 450 位具人口代表性的公民，以十人一組進行審議。
...
- **搭橋式排序的透明度。** 我們可以審核平台的關係健康度。X.com 已在測試將搭橋式排序（源自「社群備註」）作為部分用戶的預設動態。其新推出的「協作備註」功能讓人類貢獻者請求 AI 起草脈絡，再集體評分與修潤——一種雙車道模式：AI 提供速度，人類提供判斷。
...
- **聯邦原則（Federation）：** 各 AI 之間協議出一套共享的和平互動規則，如同國家之間協議貿易法規與外交禮節。這為合作創造了共同基礎。
- **輔助原則（Subsidiarity）：** 這是一個簡單卻深刻的概念：**問題應盡可能在最在地的層級解決。** 國家級的 AI 不應干涉城市級的 AI，除非出現城市本身確實無法解決的問題。這保障了每個在地「地神」的自主性與使命。
