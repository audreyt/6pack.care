...
我們通常試著透過設定規則與目標來將 AI 對齊——這些由上而下的控制是為了確保安全。這些工具很重要，但還不夠。這樣的背後存在一種假設：AI 是需要被馴服的力量。（可證偽論）當我們從恐懼出發，往往陷入兩種極端——駁反一切或絕對臣服——而不是建立健康的關係。

AI 不是生存在真空中 ; 它存在於我們的社群裡，且受權力動態和衝突價值觀的影響。當其運作的比我們更快時，我們要的並非擬人化的幻象，而是對相互依存的誠實。我們需要將對話與相互回應，直接融入 AI 的建造與治理方式中。

網路不是法外之地，更是關懷倫理的新領域。我們稱此為**公民關懷**。結合關懷倫理與 ⿻多元宇宙（Plurality）運動，這個方法視我們每個人為園丁。AI 成為了在地的基礎設施——一種場所精神，一位**地神**（Kami）——以信任實際生長的速度來支持關懷。這不是關於殖民或最大化；這是關於照料花園。
...
我們的計畫包括一份[宣言](/tw/manifesto/)和一本預計 2026 年出版的書，探討如果我們認真看待瓊・特龍托的關懷倫理，並將其作為 AI 對齊的策略，會發生什麼事。
...
[《⿻多元宇宙（Plurality）》](https://plurality.net/)將此應用於科技。受 vTaiwan 等實驗啟發，它將關懷轉化為一個流程：辨識需求（覺察力）、收集觀點（負責力）、研擬方案（勝任力）、尋求共識（回應力），並維持信任（團結力）。
